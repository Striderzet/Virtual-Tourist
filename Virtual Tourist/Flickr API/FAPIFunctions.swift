...
class FAPIFunctions {
    ...
    static func searchByLatLon(lat: Double,long: Double, finalImage: @escaping(_ GO: Bool, _ image: UIImage) -> Void) {
        let methodParameters = [
            ...
            Constants.FlickrParameterKeys.BoundingBox: FAPIFunctions.init().bboxString(latitude: lat, longitude: long),
            Constants.FlickrParameterKeys.SafeSearch: Constants.FlickrParameterValues.UseSafeSearch,
            Constants.FlickrParameterKeys.Extras: Constants.FlickrParameterValues.MediumURL,
            Constants.FlickrParameterKeys.Format: Constants.FlickrParameterValues.ResponseFormat,
            Constants.FlickrParameterKeys.NoJSONCallback: Constants.FlickrParameterValues.DisableJSONCallback
        ]
        FAPIFunctions.init().displayImageFromFlickrBySearch(methodParameters as [String:AnyObject]) { good, image in
            if good{
